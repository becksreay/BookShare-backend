"""
Django settings for book_share project.
...
SECRET_KEY = 'django-insecure-@h@c31n$s$4nxp&aohoqz2vbg&1iz!8n&xg2ghs*eh^n1#m@lj'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '127.0.0.1', '10.0.2.2', 'bookshare-server.onrender.com']
...
WSGI_APPLICATION = 'book_share.wsgi.application'
